...
source("/Volumes/GoogleDrive/My Drive/IIO-UABC/Cursos/FCM/Analisis_R/Posgrado/wk8/Week08_Maps/functions/MapFunctions.R")
```
...
# tiff(filename = "./plots/Baja_test.tiff",
...
# Run this when you are ready to save the map plot as TIFF file
# Remember you can save in other formats too
# tiff(filename = "./plots/BV_map.tiff",
